  ...
  child: Column(
    ...
    children: [
      ...
      Row(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          buttonMenu('Gestion de usuarios', Icons.manage_accounts_outlined,
              Colors.indigo, () {
            print('Ir a Gestión de usuarios');
          }),
          const SizedBox(width: 30),
          buttonMenu('Inventarios', Icons.inventory_2_outlined, Colors.red,
              () {
